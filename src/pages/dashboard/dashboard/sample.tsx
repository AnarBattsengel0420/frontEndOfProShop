...
export const CAPACITY_COLUMNS = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        flex: 1,
        sorter: (a: DataType, b: DataType) =>
          a.arrivalBorder.localeCompare(b.arrivalBorder),
      },
      {
        title: "Ирэх/Явах",
        dataIndex: "import",
        flex: 1,
        sorter: (a: DataType, b: DataType) =>
          Number(a.import) - Number(b.import),
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        flex: 1,
        sorter: (a: DataType, b: DataType) =>
          Number(a.unloadedSite) - Number(b.unloadedSite),
      },
      {
        title: "Талбайд ирсэн",
        ...
        flex: 1,
        sorter: (a: DataType, b: DataType) =>
          Number(a.arrivedSite) - Number(b.arrivedSite),
      },
      {
        title: "Задарсан",
        dataIndex: "unloaded",
        flex: 1,
        sorter: (a: DataType, b: DataType) =>
          Number(a.unloaded) - Number(b.unloaded),
      },
      {
        title: "Суларсан",
        dataIndex: "released",
      ...
      },
      {
        ...
        flex: 1,
        sorter: (a: DataType, b: DataType) =>
          Number(a.broker) - Number(b.broker),
      },
    ],
  },
  {
